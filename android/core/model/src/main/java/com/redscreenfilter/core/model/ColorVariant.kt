package com.redscreenfilter.core.model
 ...
 * - AMBER_WARM: Soft amber for lower perceived harshness
 * - RED_PINK: Red-pink for deuteranopia users
 * - HIGH_CONTRAST: High contrast red for visibility
 * - DEEP_MAROON: Deep maroon for minimal glare
 */
enum class ColorVariant(
    ...
    AMBER_WARM(
        ...
        colorValue = Color.argb(255, 255, 145, 0),
        descripton = "Warm amber - Softer tone for longer sessions"
    ),
    RED_PINK(
    ...
    DEEP_MAROON(
        displayName = "Deep Maroon",
        colorValue = Color.argb(255, 168, 24, 32),
        descripton = "Deep maroon - Reduced glare in dark rooms"
    );
